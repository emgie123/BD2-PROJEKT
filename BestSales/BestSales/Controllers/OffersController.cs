...
namespace BestSales.Controllers
{
    public class OffersController : Controller
    {
        ...
        public ActionResult Offers(int? filter)
        {
           ...
           if(filter!=null) dbAccess.CarDisplayCondtions = (x, y) => (y.MarkiSamochodow.First(z => z.IdMarki == (y.ModeleSamochodow.FirstOrDefault(v => v.IdModelu == ((DaneSamochodu)x).IdModelu).IdMarki)).IdMarki == filter);
