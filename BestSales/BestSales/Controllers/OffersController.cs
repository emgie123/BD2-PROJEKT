...
namespace BestSales.Controllers
{
    public class OffersController : Controller
    {
        ...
        public ActionResult Offers(int? filter)
        {
           ...
           if(filter!=null) dbAccess.CarDisplayContidion = (x, y) => (y.MarkiSamochodow.First(z => z.IdMarki == (y.ModeleSamochodow.FirstOrDefault(v => v.IdModelu == ((DaneSamochodu)x).IdModelu).IdMarki)).IdMarki == filter);
           else dbAccess.CarDisplayContidion = (x,y)=> true;
